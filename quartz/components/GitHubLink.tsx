...
const defaultOptions: GitHubLinkOptions = {
  href: "https://github.com/self-evolving/repo",
  label: "View Sepo on GitHub",
}

export default ((opts?: Partial<GitHubLinkOptions>) => {
  const options = { ...defaultOptions, ...opts }

  const GitHubLink: QuartzComponent = ({ displayClass }: QuartzComponentProps) => (
    <a
      class={classNames(displayClass, "github-link")}
      href={options.href}
...
`
  ...
  return GitHubLink
}) satisfies QuartzComponentConstructor<Partial<GitHubLinkOptions> | undefined>
