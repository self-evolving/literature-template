...
exports.SELF_APPROVAL_STATUS_MARKER = void 0;
exports.envFlagEnabled = envFlagEnabled;
exports.evaluateSelfApprovalActor = evaluateSelfApprovalActor;
exports.evaluateSelfApprovalProvenance = evaluateSelfApprovalProvenance;
exports.parseSelfApprovalDecision = parseSelfApprovalDecision;
exports.resolveSelfApproval = resolveSelfApproval;
exports.formatSelfApprovalBody = formatSelfApprovalBody;
const handoff_js_1 = require("./handoff.js");
const response_js_1 = require("./response.js");
const review_synthesis_js_1 = require("./review-synthesis.js");
exports.SELF_APPROVAL_STATUS_MARKER = "<!-- sepo-agent-self-approval -->";
...
function evaluateSelfApprovalActor(input) {
...
function evaluateSelfApprovalProvenance(input) {
    ...
    const signals = input.comments
        ...
        if (!author || author !== trustedActor)
            return null;
        const body = String(comment.body || "");
        if (!(0, review_synthesis_js_1.isReviewSynthesisBody)(body))
            return null;
        return {
            index,
            createdAtMs: createdAtMs(comment.createdAt),
            conclusion: (0, handoff_js_1.extractReviewConclusion)(body),
            recommendedNextStep: (0, handoff_js_1.extractReviewRecommendedNextStep)(body),
            reviewedHeadSha: (0, review_synthesis_js_1.extractReviewSynthesisHeadSha)(body),
        };
    })
...
function parseSelfApprovalDecision(raw) {
    ...
    const inspectedHeadSha = String(record.inspected_head_sha ?? record.inspectedHeadSha ?? record.head_sha ?? record.headSha ?? "").trim();
    return {
        verdict,
...
function resolveSelfApproval(input) {
...
function formatSelfApprovalBody(input) {
    ...
    lines.push("", exports.SELF_APPROVAL_STATUS_MARKER);
    return lines.join("\n");
}
//# sourceMappingURL=self-approval.js.map