...
exports.hasLiveMention = exports.DEFAULT_MENTION = exports.DEFAULT_TRUSTED_ASSOCIATIONS = void 0;
exports.getAuthorAssociation = getAuthorAssociation;
exports.getRequestedBy = getRequestedBy;
exports.extractEventContext = extractEventContext;
exports.shouldSkipSender = shouldSkipSender;
exports.shouldRespondToMention = shouldRespondToMention;
const mentions_js_1 = require("./mentions.js");
Object.defineProperty(exports, "hasLiveMention", { enumerable: true, get: function () { return mentions_js_1.hasLiveMention; } });
exports.DEFAULT_TRUSTED_ASSOCIATIONS = new Set([
    "OWNER",
    "MEMBER",
    "COLLABORATOR",
    "CONTRIBUTOR",
]);
exports.DEFAULT_MENTION = "@sepo-agent";
function joinTitleAndBody(title, body) {
    return [title, body].filter(Boolean).join("\n\n");
}
function getPreviousEditedBody(eventName, payload) {
 ...
 */
function getAuthorAssociation(eventName, payload) {
    if (eventName === "issue_comment") {
    ...
    if (eventName === "discussion") {
        return (payload.discussion?.authorAssociation ||
            payload.discussion?.author_association ||
            "NONE");
    }
    if (eventName === "discussion_comment") {
        return (payload.comment?.authorAssociation ||
 ...
 */
function getRequestedBy(eventName, payload) {
 ...
 */
function extractEventContext(eventName, payload) {
    if (eventName === "issues") {
    ...
    if (eventName === "discussion") {
        ...
        return {
            ...
            targetUrl: payload.discussion?.html_url || payload.discussion?.url || "",
 ...
 */
function shouldSkipSender(payload) {
 ...
 */
function shouldRespondToMention(eventName, payload, mention) {
    const currentBody = extractEventContext(eventName, payload).body;
    if (!(0, mentions_js_1.hasLiveMention)(currentBody, mention)) {
        return false;
    }
    ...
    return !(0, mentions_js_1.hasLiveMention)(previousBody, mention);
}
