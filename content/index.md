...
Check [Install into an existing repository](docs/deployment/install-existing-repository.md) for the detailed guide.
...
- [Install into an existing repository](docs/deployment/install-existing-repository.md)

Understanding the system:

- [Overall design](docs/architecture/overall-design.md)
- [Supported workflows](docs/architecture/supported-workflows.md)
- [Agent actions](docs/actions/agent-actions.md)
...
See the [full documentation index](docs/index.md) for technical details, deployment options, and the complete docs tree.
